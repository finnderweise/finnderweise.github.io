...
function init() {
  ...
  function gameOver() {
    if (!goSoundPlayed == true) {
      console.log("DEBUG: took the l.")
      if (canPlaySound) {
        new Audio("game_over.ogg").play();
      }
      goSoundPlayed = true
    }
    platforms.forEach(function(p, i) {
...
function closeNotice() {
  $(".notice").css("animation", "noticeAccept 0.4s")
  $(".noticeContainer").fadeOut(400)
